...
export const metadata: Metadata = {
  title: "굿잡 (GoodJob) - 취준생을 위한 스마트 채용 큐레이션 & 굿잡 라운지",
  ...
  keywords: [
    ...
    "자소서 마감일", "D-Day", "취업 매칭률", "익명 커뮤니티", "굿잡 라운지", "연봉 정보"
  ],
  authors: [{ name: "GoodJob Team" }],
  openGraph: {
    title: "굿잡 (GoodJob) - 스마트 채용 큐레이션 & 굿잡 라운지",
    description: "중복 광고 없는 클린 채용 정보와 24시간 미답변 없는 AI 멘토링 케어. 지금 바로 내 스펙 매칭률을 확인해보세요!",
    url: "https://goodjob-83j.pages.dev",
    siteName: "굿잡 (GoodJob)",
    locale: "ko_KR",
    type: "website",
  },
